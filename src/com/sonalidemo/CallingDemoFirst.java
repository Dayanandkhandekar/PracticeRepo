...
class slm {
	...
	void m1() {// instance method
		...
		System.out.println("c====" + c);// static variable access in instance mathod because static field la memory
										// class loading la bhetali

	}

	static void m2() {// static method
		slm obj = new slm();// object create for instance field memory
		System.out.println("c====" + c);// static variable access in static mathod because static field la memory class
										// loading la bhetali
	...
	static {
		...
		System.out.println("c====" + c);// static variable access in static block memory class loading chya veles
										// bhetali
...
class Pqr {
	...
	void m3() {// instance method
		...
		System.out.println("s===" + obj.s);// instance variable access in instance method object create kelyavr memory
											// bhetali
		int w;
	}
